...
// Componentes Ekade
import { EkadeSidebarComponent } from './components/ekade-common/sidebar/sidebar.component';
import { EkadeFooterComponent } from './components/ekade-common/footer/footer.component';
import { EkadeHeaderComponent } from './components/ekade-common/header/header.component';
import { EkadeCustomizerSettingsComponent} from './components/ekade-customizer-settings/customizer-settings.component';
import { EkadeDashboardComponent} from './components/ekade-dashboard/dashboard.component';


@NgModule({
    declarations: [

        // Declaración de componentes Ekade
        EkadeFooterComponent,
        EkadeSidebarComponent,
        EkadeHeaderComponent,
        EkadeCustomizerSettingsComponent,
        EkadeDashboardComponent,
